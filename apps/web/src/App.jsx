...
const implementedRoutes = new Set([
  ...
  '/my-page', '/data-updates', '/integrations/github', '/signatures', '/final-download',
...
export default function App() {
  return (
    <Routes>
      ...
      <Route element={<UserRoute><SignaturesPage /></UserRoute>} path="/signatures" />
      <Route element={<UserRoute><FinalDownloadPage /></UserRoute>} path="/final-download" />
