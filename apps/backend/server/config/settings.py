...
# server directory may live under apps/backend/server in monorepo mode
PROJECT_ROOT = BASE_DIR.parents[2] if BASE_DIR.parent.name == "backend" and BASE_DIR.parent.parent.name == "apps" else BASE_DIR.parent
...
DATABASES = {
    "default": {
        ...
        "NAME": PROJECT_ROOT / "projectnote.db",
    }
}
